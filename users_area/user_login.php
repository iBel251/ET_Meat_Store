            ...
            <div class="col-lg-4 col-xl-6">
                <form action="" method="post">
                    ...
                    <div class="mt-4 pt-2">
                        ...
                        <p class="small font-weight-bold mt-2 pt-1">Don't have an account? <a href="/et_meat_store/users_area/user_registration.php" class="text-danger">Register</a></p>
                    </div>
                </form>
            </div>
        </div>
    ...
    if ($row_count > 0) {
        ...
        if (password_verify($user_password, $row_data['user_password'])) {
            ...
            if ($row_count == 1 and $row_count_cart == 0) {
                echo "<script>window.open('/et_meat_store/index.php','_self')</script>";
            } else {
                echo "<script>window.open('/et_meat_store/cart.php','_self')</script>";
            }
        } else {
