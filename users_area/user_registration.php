            ...
            <div class="col-lg-4 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" id="user_address" class="form-control" placeholder="Enter your mobile number" autocomplete="off" required name="user_contact">
                    </div>
                    <div class="mt-4 pt-2">
                        <input type="submit" value="Register" class="bg-info py-2 px-3 border-0" name="user_register">
                        <p class="small font-weight-bold mt-2 pt-1">Already have an account? <a href="user_login.php" class="text-danger">Login</a></p>
                    </div>
                </form>
            </div>
        </div>
...
if (isset($_POST['user_register'])) {
   ...
   // selecting cart intl_get_error_message 
